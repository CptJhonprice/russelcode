 ...
 * Conic gradients are inline so they don't depend on Tailwind gradient utilities.
 */
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        ...
        {/* Blur base behind the lamp line */}
      ...
      <div className="relative z-50 flex -translate-y-[18vh] flex-col items-center px-5">
        {children}
      </div>
    </div>
  );
